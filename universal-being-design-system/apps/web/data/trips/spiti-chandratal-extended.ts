...
export const spitiChandratalExtendedTrip = buildTrip({
  ...
  itinerary: [
    ...
    { day: 5, title: "Dhankar Monastery & Pin Valley", description: "Visit the cliff-top Dhankar Monastery, then a detour into the remote Pin Valley.", activities: ["Dhankar Monastery visit", "Pin Valley detour"], meals: ["breakfast", "lunch", "dinner"], stay: "Hotel/homestay in Kaza" },
    { day: 6, title: "Kaza to Tabo", description: "Drive down-valley to Tabo, home to a thousand-year-old monastery.", activities: ["Tabo Monastery visit"], meals: ["breakfast", "lunch", "dinner"], stay: "Homestay in Tabo" },
    { day: 7, title: "Tabo to Chitkul via Nako", description: "Long scenic drive through Nako village towards Chitkul, India's last inhabited village on this route.", activities: ["Nako Lake stop", "Drive to Chitkul"], meals: ["breakfast", "lunch", "dinner"], stay: "Homestay in Chitkul" },
    { day: 8, title: "Chitkul buffer day", description: "A full extra day at Chitkul to explore the village, the Baspa river, and nearby Rakcham at a slower pace.", activities: ["Chitkul village walk", "Baspa river viewpoint", "Rakcham day trip"], meals: ["breakfast", "lunch", "dinner"], stay: "Homestay in Chitkul" },
