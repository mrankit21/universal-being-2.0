...
/**
 * LeadAssigneeSelect — per-lead "Assigned to" dropdown on the admin Leads
 * page. Doubles as the management UI for the Salesperson list itself: the
 * same panel that lets you assign a lead also lets you type a new name to
 * add, or remove an existing one — there's no separate "Manage
 * salespeople" screen, since the list only ever exists to be picked from
 * here.
 */
...
export function LeadAssigneeSelect({
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div className="absolute right-0 z-50 mt-1 w-56 rounded-md border border-border bg-popover shadow-md">
