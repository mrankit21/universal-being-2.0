...
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className={cn(
        "ub-glass ub-nav-black fixed inset-x-3 bottom-3 z-40 flex items-center justify-around rounded-full border border-border/60 py-1.5 shadow-ub-lg md:hidden",
