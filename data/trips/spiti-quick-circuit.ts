...
export const spitiQuickCircuitTrip = buildTrip({
  ...
  itinerary: [
    ...
    { day: 5, title: "Kaza to Chandratal (return leg)", location: "Chandratal", description: "Retrace the route back over Kunzum Pass towards Chandratal for a final night under the stars.", activities: ["Kunzum Pass crossing (return)", "Evening at Chandratal"], meals: ["breakfast", "lunch", "dinner"], stay: "Camp near Chandratal" },
