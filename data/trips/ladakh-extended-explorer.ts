...
export const ladakhExtendedExplorerTrip = buildTrip({
  ...
  itinerary: [
    ...
    { day: 5, title: "Pangong to Tso Moriri", location: "Tso Moriri", description: "Drive along remote high-altitude roads from Pangong to the Tso Moriri wetlands.", activities: ["High-altitude plateau drive", "Tso Moriri lakeside walk"], meals: ["breakfast", "dinner"], stay: "Camp near Tso Moriri" },
    { day: 6, title: "Tso Moriri to Leh via Chumathang", location: "Leh", description: "Return route via Chumathang hot springs back into Leh.", activities: ["Chumathang hot springs", "Return to Leh"], meals: ["breakfast", "dinner"], stay: "Hotel in Leh" },
    { day: 7, title: "Leh to Kargil via Lamayuru", location: "Kargil", description: "Drive west to Kargil, stopping at Lamayuru monastery and the Moonland landscape.", activities: ["Lamayuru Monastery", "Moonland viewpoint"], meals: ["breakfast", "dinner"], stay: "Hotel in Kargil" },
    { day: 8, title: "Kargil to Zanskar valley day trip", location: "Zanskar Valley", description: "Day trip into the Zanskar valley before returning toward Leh.", activities: ["Zanskar valley drive", "Sani Monastery"], meals: ["breakfast", "dinner"], stay: "Hotel in Kargil" },
