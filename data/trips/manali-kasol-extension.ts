...
export const manaliKasolExtensionTrip = buildTrip({
  ...
  itinerary: [
    ...
    { day: 4, title: "Atal Tunnel & Sissu", location: "Sissu", description: "Cross the Atal Tunnel into Lahaul valley, visit Sissu and its waterfall, return to Manali by evening.", activities: ["Atal Tunnel crossing", "Sissu village and waterfall", "Return drive to Manali"], meals: ["breakfast", "dinner"], stay: "Hotel in Manali (or similar)" },
    { day: 5, title: "Kasol & Tosh day trip", location: "Kasol", description: "Full day trip into the Parvati valley, exploring Kasol's cafés and the quiet lanes of Tosh village.", activities: ["Kasol café walk", "Tosh village visit"], meals: ["breakfast", "dinner"], stay: "Hotel in Manali (or similar)" },
